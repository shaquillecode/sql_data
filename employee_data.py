...
with open(FILEPATH, 'r', encoding='UTF8') as fin:
    ...
    #print("days", days)
    all_employees_by_last = [f"{g[0]}, {g[1]}, {g[2]}" for g in curr.execute("SELECT last_name, first_name, sick_days_accumulated FROM allData WHERE CAST(sick_days_accumulated as int) > {0}".format(SICK_DAYS)).fetchall()]
